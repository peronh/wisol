    ...
    var i = j.$JssorSlider$ = (j.module || {}).exports = function() {
        ...
        function xc(e, h, o) {
            ...
            l.$ScaleSize = function(q, p, t) {
                ...
                } else s = r = l = c.q(O < M ? p : q, j.$Scale);
                var x = h ? 1.001 : 1,
                    u = l * x;
                b.cg(a, u);
                ...
                b.$CssWidth(g, f.D * s);
                b.$CssHeight(g, f.E * r);
                var v = b.$IsBrowserIE() && b.$BrowserEngineVersion() < 9 || b.$BrowserEngineVersion() < 10 && b.$IsBrowserIeQuirks() ? u : 1,
                    y = (s - v) * f.D / 2,
                    z = (r - v) * f.E / 2;
                b.R(a, y);
                b.U(a, z);
                b.$Each(f, function(d, a) {
                    if (i[a] && d) {
                        var e = (i[a] & 1) * c.q(q, k[a]) * d + (i[a] & 2) * c.q(p, k[a]) * d / 2;
                        b.ze[a](g, e)
                    }
                });
                b.Bc(g, j.$AutoCenter)
